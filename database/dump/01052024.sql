...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2024 at 06:42 AM
...
CREATE TABLE `layouts` (
  ...
  `localization` varchar(191) DEFAULT 'US'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `maps` (
  ...
  `geocode_map_key` varchar(255) DEFAULT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `javascript_map_key` varchar(191) DEFAULT NULL,
  `distance_unit` enum('km','miles') NOT NULL DEFAULT 'miles',
  `distance_radius` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `maps` (`id`, `name`, `sku`, `geocode_map_key`, `state`, `lat`, `long`, `active`, `zoom`, `zoom_profile`, `created_at`, `updated_at`, `javascript_map_key`, `distance_unit`, `distance_radius`) VALUES
(1, 'Google Maps API', 'google_maps_api', NULL, NULL, '38.9072', '-77.0369', 1, 10, 15, '2020-06-11 05:47:08', '2023-07-28 15:02:14', NULL, 'miles', NULL);
...
(218, '2024_03_22_062948_add_javascript_map_key_to_maps_table', 76),
(219, '2024_03_26_070558_add_timezone_to_layouts_table', 76),
(220, '2024_04_05_051448_add_distance_radius_to_maps_table', 76);
