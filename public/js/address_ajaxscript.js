...
$(document).ready(function(){
    ...
    $(document).on('click','.open_modal',function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#address_state_province').val(data.address_state_province);
                $('#address_postal_code').val(data.address_postal_code);
    ...
    // $("#btn-save").click(function (e) {
        ...
        var formData = {
            ...
            address_state_province: $('#address_state_province').val(),
