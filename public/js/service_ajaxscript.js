...
$(document).ready(function(){
    ...
    $(document).on('click','.open_modal',function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#service_email').val(data.service_email);
                $('#service_status').val(data.service_status);
                $('#service_application_process').val(data.service_application_process);
                $('#service_wait_time').val(data.service_wait_time);
                $('#service_fees').val(data.service_fees);
                $('#service_accreditations').val(data.service_accreditations);
                $('#service_metadata').val(data.service_metadata);
    ...
    // $("#btn-save").click(function (e) {
        ...
        var formData = {
            ...
            service_alternate_name: $('#service_alternate_name').val(),
            ...
            service_application_process: $('#service_application_process').val(),
            service_wait_time: $('#service_wait_time').val(),
            service_fees: $('#service_fees').val(),
            service_accreditations: $('#service_accreditations').val(),
            service_metadata: $('#service_metadata').val()
        }
