...
class UploadController extends Controller
{
    ...
    public function zip(Request $request)
    {
        ...
        var_dump($extension);
        var_dump($filename);
        var_dump($request->file('file_zip'));
    ...
    public function zip_cron(Request $request)
    {
        ...
        // $filename =  'datapackage.zip';
        // $today = date("Y-m-d H:i:s");
        // $today = str_replace(':', '-', $today);
        // $today = str_replace(' ', '-', $today);
        // $today_filename = 'datapackage'.$today.'.zip';
        // $destination = public_path('/zip-backup/');
        ...
        // } else {
        //     $download_path = '/home/admin-pc/Downloads/';
        // }

        // $disk = \Storage::disk('s3');
        // $disk->put($today_filename, file_get_contents('/home/admin-pc/Downloads/' . $filename));

        // rename('/home/admin-pc/Downloads/'.$filename, $destination.$filename);

        // \Zipper::make($destination.$filename)->extractTo('HSDS');
