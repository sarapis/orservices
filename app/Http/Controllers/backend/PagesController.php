...
class PagesController extends Controller
{
    ...
    public function export_hsds_zip_file(Request $request)
    {
        ...
        fputcsv($file_location, array('id', 'location_recordid', 'organization_id', 'name', 'alternate_name', 'description', 'transportation', 'latitude', 'longitude'));
        ...
        fputcsv($file_organization, array('id', 'organization_recordid', 'name', 'alternate_name', 'description', 'email', 'url', 'tax_status', 'tax_id', 'year_incorporated', 'legal_status'));
        ...
        fputcsv($file_contact, array('id', 'contact_recordid', 'organization_id', 'service_id', 'service_at_location_id', 'name', 'title', 'department', 'email'));
        ...
        fputcsv($file_phone, array('id', 'phone_recordid', 'location_id', 'service_id', 'organization_id', 'contact_id', 'service_at_location_id', 'number', 'extension', 'type', 'language', 'description', 'department'));
        ...
        fputcsv($file_address, array('id', 'address_recordid', 'location_id', 'attention', 'address_1', 'address_2', 'address_3', 'address_4', 'city', 'region', 'state_province', 'postal_code', 'country'));
        ...
        fputcsv($file_language, array('id', 'language_recordid', 'service_id', 'location_id', 'language'));
        ...
        fputcsv($file_taxonomy, array('id', 'term', 'description', 'parent_id', 'taxonomy', 'language', 'x_taxonomies', 'taxonomy_x_notes', 'badge_color', 'taxonomy_recordid'));
        ...
        fputcsv($file_schedule, array('id', 'service_id', 'location_id', 'service_at_location_id', 'valid_from', 'valid_to', 'dtstart', 'until', 'wkst', 'freq', 'interval', 'byday', 'byweekno', 'bymonthday', 'byyearday', 'description', 'schedule_recordid'));
