...
class Schedule extends Model
{
    ...
    protected $fillable = [
        'schedule_recordid', 'schedule_id', 'schedule_services', 'schedule_locations', 'schedule_x_phones', 'schedule_days_of_week', 'opens_at', 'closes_at', 'schedule_holiday', 'schedule_start_date', 'schedule_end_date', 'address_locations', 'schedule_closed', 'flag', 'schedule_description',
    ];
