        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content" style="overflow: scroll;">
                    ...
                    <table id="example" class="display nowrap table-striped jambo_table table-bordered table-responsive"
                            ...
                            @foreach ($organizations as $key => $organization)
                                <tr id="organization{{ $organization->id }}" class="{{ $organization->flag }}">
                                    ...
                                    <td class="text-center"><span
                                            style="white-space:normal;">{!! $organization->organization_description !!}</span></td>
                                    ...
                                    <td class="text-center">
                                        @if (isset($organization->contact()->first()->contact_name))
                                            <span
                                                class="badge bg-red">{{ $organization->contact()->first()->contact_name }}</span>
                                        @endif
                                    </td>

                                    @if ($source_data->active == 1)
                                        <td class="text-center">
                                            @if ($organization->organization_details != '')
