    ...
    <div class="x_panel">
      <div class="x_title">
        ...
        <div class="nav navbar-right panel_toolbox">
          <a href="{{route('address_types.create')}}" class="btn btn-success">New Address Type</a>
      ...
      <div class="x_content">
        ...
        @endif
        <table class="table table-striped jambo_table bulk_action" id="tblAddressTypes">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{route('address_types.edit', $type->id)}}" class="btn btn-primary btn-xs"><i
                    class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>


                {!! Form::open(['method'=>'DELETE', 'route' => ['address_types.destroy', $type->id],
                'style' =>
                'display:inline']) !!}
                <button type="submit" class="btn btn-danger btn-xs" data-original-title="Delete"
                  onclick="return confirm('Are you sure to delete this type')" data-placement="top"><i
...
<script type="text/javascript">
  $(document).ready(function(){
        table = $('#tblAddressTypes').DataTable({
          'columnDefs': [{
            'targets': 0,
            'searchable':false,
            'orderable':false,
