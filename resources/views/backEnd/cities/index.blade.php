    ...
    <div class="x_panel">
      <div class="x_title">
        ...
        <div class="nav navbar-right panel_toolbox">
          <a href="{{route('cities.create')}}" class="btn btn-success">New City</a>
      ...
      <div class="x_content">
        ...
        @endif
        <table class="table table-striped jambo_table bulk_action" id="tblCities">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{route('cities.edit', $city->id)}}" class="btn btn-primary btn-xs"><i
                ...
                <button type="submit" class="btn btn-danger btn-xs" data-original-title="Delete"
                  onclick="return confirm('Are you sure to delete this city')" data-placement="top"><i
