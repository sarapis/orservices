                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                {!! Form::select('organization', $organizations, $organization_id, ['class' => 'form-control selectpicker', 'id' => 'organization', 'placeholder' => 'Select ', 'data-live-search' => 'true', 'data-size' => '5']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select class="form-control selectpicker" data-live-search="true" id="dataType"
                                    name="dataType" data-size="5">
          ...
          <div class="form-group">
              ...
              <div class="col-sm-7">
                  <select class="form-control selectpicker" data-live-search="true" id="session_disposition"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select class="form-control selectpicker" data-live-search="true" id="fieldType"
                                    name="fieldType" data-size="5">
                                    <option value="">Select </option>
                ...
                <div class="x_content">
                    ...
                    <table id="edits_table" class="display table-striped jambo_table table-bordered " cellspacing="0"
                        width="100%">
                        <thead>
                            <tr>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        let ajaxUrl
        if (id != 0) {
            ajaxUrl = "{{ route('edits.userEdits', ['id' => $id, 'organization_id' => $organization_id]) }}";
            extraData.user = id
        } else if (organization_id != 0) {
            ajaxUrl = "{{ route('edits.organization_edits', ['id' => $id, 'organization_id' => $organization_id]) }}";
