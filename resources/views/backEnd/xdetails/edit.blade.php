			...
			<div class="x_content">
                {{ Form::model($xdetails,array('method' => 'PATCH','url' => route('XDetails.update',$xdetails->id), 'class' => 'form-horizontal','files' => true)) }}
                    ...
                    <div class="form-group {{ $errors->has('detail_services') ? 'has-error' : ''}}">
                        ...
                        <div class="col-sm-6">
                            {!! Form::select('detail_services',$services,$serviceIds,['class' => 'form-control','id' => 'detail_services','placeholder' => 'select']) !!}
                    ...
                    <div class="form-group {{ $errors->has('detail_organizations') ? 'has-error' : ''}}">
                        ...
                        <div class="col-sm-6">
                            {!! Form::select('detail_organizations',$organizations,null,['class' => 'form-control','placeholder' => 'select','id' => 'detail_organizations' ]) !!}
                    ...
                    <div class="form-group {{ $errors->has('detail_locations') ? 'has-error' : ''}}">
                        ...
                        <div class="col-sm-6">
                            {!! Form::select('detail_locations',$locations,null,['class' => 'form-control','placeholder' => 'select','id' => 'detail_locations']) !!}
