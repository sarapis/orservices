    ...
    <div class="x_panel">
      <div class="x_title">
        ...
        <div class="nav navbar-right panel_toolbox">
          <a href="{{route('code_categories.create')}}" class="btn btn-success">New SDOH Domain</a>
      ...
      <div class="x_content">
        ...
        @endif
        <table class="table table-striped jambo_table bulk_action" id="tblcode_categories">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{route('code_categories.edit', $domain->id)}}" class="btn btn-primary btn-xs"><i
                    class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                {!! Form::open(['method'=>'DELETE', 'route' => ['code_categories.destroy', $domain->id],
                'style' =>
                'display:inline']) !!}
                <button type="submit" class="btn btn-danger btn-xs" data-original-title="Delete"
                  onclick="return confirm('Are you sure to delete this domain')" data-placement="top"><i
        ...
        {{-- @if (Sentinel::getUser()->hasAccess(['code_categories.destroy']))
...
<script type="text/javascript">
  $(document).ready(function(){
        table = $('#tblcode_categories').DataTable({
          'columnDefs': [{
            'targets': 0,
            'searchable':false,
            'orderable':false,
