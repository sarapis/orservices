              ...
              <li><a href="/FacilityTypes">Location Type</a></li>
                ...
                <li><a><img src="/images/Classifications.png" alt="" style="margin-left: -5px;width: 25px">
                    ...
                    <ul class="nav child_menu">
                        ...
                        <li><a href="{{ route('phone_types.index') }}">Phone Types</a></li>
                        <li><a href="{{ route('detail_types.index') }}">Detail Types</a></li>
                        <li><a href="{{ route('taxonomy_types.index') }}">Taxonomies</a></li>
                        <li><a href="{{ route('organization_status.index') }}">Organization Statuses</a></li>
                        <li><a href="{{ route('cities.index') }}">Cities</a></li>
                        <li><a href="{{ route('states.index') }}">States</a></li>
                        <li><a href="{{ route('codes.index') }}">SDOH Codes</a></li>
                        <li><a href="{{ route('code_categories.index') }}">SDOH Domains</a></li>
                        <li><a href="{{ route('code_systems.index') }}">SDOH Code Systems</a></li>
                        ...
                        <li><a href="{{ route('dispositions.index') }}">Dispositions</a></li>
