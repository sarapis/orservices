                    ...
                    <ul class="nav nav-tabs tabpanel_above">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#sdoh-category-tab">
                                <h4 class="card_services_title">Social Needs</h4>
                            </a>
                        </li>
                        @endif
                    </ul>
