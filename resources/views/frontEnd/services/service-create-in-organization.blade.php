...
@section('content')
        ...
        <div id="contacts-content" class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    {!! Form::open(['route' => 'add_new_service_in_organization']) !!}
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('fee_option[]', $fee_options, null, [ 'class' => 'form-control selectpicker', 'multiple' => true]) !!}
                                    </div>
                                </div> --}}
                                ...
                                <div id="demo" class="collapse row m-0"> --}}
                                    ...
                                    {{-- <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="help-tip">
                                                <div>
                                                    <p>An organization may have a license issued by a government entity to operate legally. A list of any such licenses can be provided here.
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="help-tip">
                                                <div>
                                                    <p>Some organizations organize their services into service groupings (e.g., Senior Services).. A service grouping brings together a number of related services.</p>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="">
                                                                <table class="table table_border_none"
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::select('service_category_type[]', $service_category_types, null, [
                                                                                    'class' => 'form-control selectpicker service_category_type',
                                                                                    'placeholder' => 'select  type',
                                                                                    'id' => 'service_category_type_0',
                                                                                ]) !!}

                                                                            </td>
                                                                            <td class="create_btn">
                                                                                {!! Form::select('service_category_term[0][]', [], null, [
                                                                                    'class' => 'form-control selectpicker service_category_term',
                                                                                    'id' => 'service_category_term_0',
                                                                                    'multiple' => true,
                                                                                    'data-size' => '5',
                                                                                    'data-live-search' => 'true',
                                                                                ]) !!}
                                                                                <input type="hidden"
                                                                                    name="service_category_term_type[]"
                                                                                    id="service_category_term_type_0"
                                                                                    value="old">
                                                                            </td>
                                                ...
                                                <h4 class="title_edit text-left mb-25 mt-10">
                                                    ...
                                                    <div class="d-inline float-right">
                                                        <a href="javascript:void(0)"
                                                            class="locationModalOpenButton plus_delteicon bg-primary-color">
                                        ...
                                        <div class="card all_form_field">
                                            <div class="card-block">
                                                                ...
                                                                <table
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="vertical-align: middle">
                                                                                <input type="checkbox" name="schedule_closed[]"
                                                                                    id="" value="7">
                                                                            </td>
                                                                            <td style="vertical-align: middle">
                                                ...
                                                <h4 class="title_edit text-left mb-25 mt-10">
                                                    Holiday Schedule
                                                    <div class="d-inline float-right">
                                                        <a href="javascript:void(0)" id="addTr"
                                                                ...
                                                                <table class="table table_border_none" id="myTable">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input type="text"
                                                                                    name="holiday_open_at[]"
                                                                                    id=""
                                                                                    class="form-control timePicker">
                                                                            </td>
                                                                            <td>
                                                                                <input type="text"
                                                                                    name="holiday_close_at[]"
                                                                                    id=""
                                                                                    class="form-control timePicker">
                                                                            </td>
                                                                            <td>
                                                                                <input type="checkbox"
                                                                                    name="holiday_closed[]" id=""
                                                                                    value="1">
                                                                            </td>
                                                                            <td style="vertical-align: middle">
                                                                                <a href="#"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span id="service_category_term_error"
                                                    style="display: none;color:red">Service Category Term is
                                                    required!</span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $('#addScheduleHolidayLocation').click(function() {
            $('#scheduleHolidayLocation').append('<tr><td> <input type="date" name="holiday_start_date" id="holiday_start_date_location_' + ls + '"></td><td> <input type="date" name="holiday_end_date" id="holiday_end_date_location_' + ls + '"></td><td> <input type="text" class="timePicker" name="holiday_open_at" id="holiday_open_at_location_' + ls + '"></td><td> <input type="text" class="timePicker" name="holiday_close_at" id="holiday_close_at_location_' + ls + '"></td><td> <input type="checkbox" name="holiday_closed" id="holiday_closed_location_' + ls + '" value="1"></td><td style="vertical-align:middle;"><a href="javascript:void(0)" class="plus_delteicon btn-button removePhoneData"><img src="/frontend/assets/images/delete.png" alt="" title=""></a></td></tr>');
            ls++;
            $('.timePicker').timepicker({
                'scrollDefault': 'now'
            });
        ...
        $('#locationSubmit').click(function() {
            ...
            $('#scheduleHolidayLocation').append('<tr><td> <input type="date" name="holiday_start_date" id="holiday_start_date_location_0"></td><td> <input type="date" name="holiday_end_date" id="holiday_end_date_location_0"></td><td> <input type="text" class="timePicker" name="holiday_open_at" id="holiday_open_at_location_0"></td><td> <input type="text" class="timePicker" name="holiday_close_at" id="holiday_close_at_location_0"></td><td> <input type="checkbox" name="holiday_closed" id="holiday_closed_location_0" value="1"></td><td style="vertical-align:middle;"><a href="javascript:void(0)" class="plus_delteicon btn-button removePhoneData"><img src="/frontend/assets/images/delete.png" alt="" title=""></a></td></tr>');
            $('.timePicker').timepicker({
                'scrollDefault': 'now'
            });
        ...
        $(document).on('click', '.removeLocationData', function() {
            var $row = jQuery(this).closest('tr');
            if (confirm("Are you sure want to remove this facility?")) {
                let contactTrId = $row.attr('id')
                let id_new = contactTrId.split('_');
                let id = id_new[1]
                let deletedId = id
        ...
        $(document).on('click', '.locationEditButton', function() {
            ...
            for (let index = 1; index < location_holiday_start_dates.length; index++) {
                $('#scheduleHolidayLocation').append(
                    '<tr><td> <input type="date" name="holiday_start_date" id="holiday_start_date_location_' + index + '" value="' + location_holiday_start_dates[index] + '"></td><td> <input type="date" name="holiday_end_date" id="holiday_end_date_location_' + index + '" value="' + location_holiday_end_dates[index] + '"></td><td> <input type="text" class="timePicker" name="holiday_open_at" id="holiday_open_at_location_' + index + '" value="' + location_holiday_open_ats[index] + '"></td><td> <input type="text" class="timePicker" name="holiday_close_at" id="holiday_close_at_location_' + index + '" value="' + location_holiday_close_ats[index] + '"></td><td> <input type="checkbox" name="holiday_closed" id="holiday_closed_location_' + index + '" value="1"></td><td style="vertical-align:middle;"><a href="javascript:void(0)" class="plus_delteicon btn-button removePhoneData"><img src="/frontend/assets/images/delete.png" alt="" title=""></a></td></tr>'
                );
                $('.timePicker').timepicker({
                    'scrollDefault': 'now'
                });
        ...
        $("#add-phone-input").click(function() {
            $("ol#phones-ul").append( "<li class='service-phones-li mb-2 col-md-4'>" + "<input class='form-control selectpicker service_phones'  type='text' name='service_phones[]'>" + "</li>");
        });
    </script>
@endsection
