...
<style type="text/css">
    button[data-id="facility_organization_name"], button[data-id="facility_service"], button[data-id="facility_schedules"], button[data-id="facility_details"], button[data-id="facility_service"], button[data-id="facility_address_city"], button[data-id="facility_address_state"], button[data-id="phone_type"], button[data-id="phone_language"]  {
        height: 100%;
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea id="location_description" name="location_description" class="form-control selectpicker" >{{$facility->location_description}}</textarea>
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker" multiple data-live-search="true" id="facility_schedules"
                                        ...
                                        <option value="{{$schedule_info->schedule_recordid}}" {{in_array($schedule_info->schedule_recordid,$facilitySchedule) ? 'selected' : '' }} >{{$schedule_info->opens_at}} ~ {{$schedule_info->closes_at}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> --}}
                                    ...
                                    <div class="">
                                        <table class="table table_border_none" id="PhoneTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="text" class="form-control" name="facility_phones[]" id="" value="{{ $value->phone_number }}">
                                                    </td>
                                                    <td>
                                                    ...
                                                    {{-- <td>
                                                        <a href="javascript:void(0)" data-id="{{ $value->phone_recordid }}" class="removePhoneData" style="color:rgb(3, 65, 8);" data-toggle="tooltip" title="Remove"> <i class="fa fa-minus-circle" aria-hidden="true"></i></a>
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <a href="javascript:void(0)" data-id="{{ $value->phone_recordid }}" class="plus_delteicon btn-button removePhoneData">
                                                            <img src="/frontend/assets/images/delete.png" alt="" title="">
                                                        </a>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {!! Form::select('phone_type[]',$phone_type,null,['class' => 'form-control selectpicker ','data-live-search' => 'true','id' => 'phone_type','data-size' => 5,'placeholder' => 'select phone type'])!!}
                                                    </td>
                                                    <td>
