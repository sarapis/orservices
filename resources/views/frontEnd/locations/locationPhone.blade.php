...
<script>
    ...
    let sp =  "{{ isset($facility) && isset( $facility->phones) ? count($facility->phones) : '0' }}";
    ...
    $(document).on('click','.removeLocationPhoneData',function(){
        var $row = jQuery(this).closest('tr');
