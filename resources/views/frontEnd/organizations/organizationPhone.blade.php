...
<script>
    ...
    let sp =  "{{ isset($organization) && isset( $organization->phones) ? count($organization->phones) : '0' }}";
    ...
    $(document).on('click','.removeOrganizationPhoneData',function(){
        var $row = jQuery(this).closest('tr');
