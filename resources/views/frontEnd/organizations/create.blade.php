...
@section('content')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker" multiple
                                                        data-live-search="true" id="service_taxonomies_p"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        id="service_application_process_p"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker" multiple
                                                        data-live-search="true" id="service_schedules_p"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker" multiple
                                                        data-live-search="true" id="service_address_p"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        id="service_airs_taxonomy_x_p" name="service_airs_taxonomy_x"
                                                        value="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="vertical-align: middle">
                                                                        <input type="checkbox"
                                                                            name="schedule_closed_location_wednesday"
                                                                            value="3"
                                                                            id="schedule_closed_location_wednesday">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Thursday
                                                                    ...
                                                                    <td style="vertical-align: middle">
                                                                        <input type="checkbox"
                                                                            name="schedule_closed_location_thursday"
                                                                            value="4"
                                                                            id="schedule_closed_location_thursday">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Friday
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="vertical-align: middle">
                                                                        <input type="checkbox"
                                                                            name="schedule_closed_location_saturday"
                                                                            id="schedule_closed_location_saturday"
                                                                            value="6">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="date" name="holiday_end_date"
                                                                            id="holiday_end_date_location_0"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" name="holiday_open_at"
                                                                            id="holiday_open_at_location_0"
                                                                            class="form-control timePicker">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" name="holiday_close_at"
                                                                            id="holiday_close_at_location_0"
                                                                            class="form-control timePicker">
                                                                    </td>
                                                                    <td>
    ...
    <script>
        ...
        // @foreach ($phone_languages as $key => $value)
