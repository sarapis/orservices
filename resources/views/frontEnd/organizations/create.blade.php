                ...
                {!! Form::open(['route' => 'organizations.store']) !!}
                    ...
                    <div class="card all_form_field">
                        <div class="card-block">
                            ...
                            <input type="hidden" name="service_taxonomies[]" id="service_taxonomies">
                            <input type="hidden" name="service_application_process[]" id="service_application_process">
                            <input type="hidden" name="service_wait_time[]" id="service_wait_time">
                            <input type="hidden" name="service_fees[]" id="service_fees">
                            <input type="hidden" name="service_accreditations[]" id="service_accreditations">
                            <input type="hidden" name="service_licenses[]" id="service_licenses">
                            <input type="hidden" name="service_schedules[]" id="service_schedules">
                            <input type="hidden" name="service_details[]" id="service_details">
                            <input type="hidden" name="service_address[]" id="service_address">
                            <input type="hidden" name="service_metadata[]" id="service_metadata">
...
<script>
    ...
    let selectedServiceTrId = ''
    // array value
    let all_services_taxonomies = []
    let all_services_schedules = []
    let all_services_details = []
    let all_services_address = []
    ...
    let s =  0;
    let service_alternate_name = []
    let service_program = []
    let service_status = []
    let service_application_process = []
    let service_wait_time = []
    let service_fees = []
    let service_accreditations = []
    let service_licenses = []
    let service_metadata = []
    let service_airs_taxonomy_x = []
