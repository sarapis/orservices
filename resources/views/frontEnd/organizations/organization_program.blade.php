    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="programSubmit" class="btn btn-primary btn-lg btn_padding green_btn">Add</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    let pr = "{{ isset($organization) ? count($organization->program) : '0' }}";
