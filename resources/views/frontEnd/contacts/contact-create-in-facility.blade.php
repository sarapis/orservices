...
@section('content')
                    ...
                    <form action="/add_new_contact_in_facility" method="GET">
                        <div class="card all_form_field">
                            <div class="card-block">
                                <div class="row">
                                    ...
                                    <input type="hidden" id="contact_facility_recordid" name="contact_facility_recordid"
                                        value="{{ $facility->location_recordid }}">
                                    <input type="hidden" id="contact_organization" name="contact_organization"
                                        value="{{ $facility->location_organization }}">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Service: </label>
                                            <select class="form-control selectpicker" multiple data-live-search="true"
                                                id="contact_service" name="contact_service[]" data-size="8">
                        ...
                        <div class="col-md-12 text-center">
                            <button type="button"
                                ...
                                id="back-contact-btn"> Back</button>
                            <button type="submit"
    ...
    <script>
        ...
        //     $('#PhoneTable tr:last').before('<tr><td><input type="text" class="form-control" name="contact_phones[]" id=""></td><td><input type="text" class="form-control" name="phone_extension[]" id=""></td><td>{!! Form::select(
            'phone_type[]',
            $phone_type,
            [],
            [
