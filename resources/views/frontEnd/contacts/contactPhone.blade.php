...
<script>
    ...
    let sp =  "{{ isset($contact) && isset( $contact->phone) ? count($contact->phone) : '0' }}";
    ...
    $(document).on('click','.removeContactPhoneData',function(){
        var $row = jQuery(this).closest('tr');
