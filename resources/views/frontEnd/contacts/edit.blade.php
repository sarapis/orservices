                                ...
                                <div class="col-md-4">
                                    ...
                                    <label>Services: </label>
                                        ...
                                        <select class="form-control selectpicker" multiple data-live-search="true" id="contact_services"
                                            name="contact_services[]" data-size="8">
                                            @foreach($service_info_list as $key => $service_info)
                                            <option value="{{$service_info->service_recordid}}" {{ in_array($service_info->service_recordid,$contact_services) ? 'selected'  :'' }}>{{$service_info->service_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <div class="">
                                            <table class="table table_border_none" id="PhoneTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="form-control" name="contact_phones[]" id="" value="{{ $value->phone_number }}">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {!! Form::select('phone_language[]',$phone_languages,[],['class' => 'form-control selectpicker','data-size' => 5,' data-live-search' => 'true','multiple'=>true,"id" => "phone_language_0"]) !!}
                                                        </td>
                                                        <td>
